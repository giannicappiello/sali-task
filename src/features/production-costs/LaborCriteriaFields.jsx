...
export default function LaborCriteriaFields({settings,onChange}) {
 ...
 <h3>STATION  {rules.station.basis==="historical_productivity"&&<CostInfo title="Metodo storico STATION"><p><strong>Ricalcolo retroattivo STATION.</strong> Dalla decorrenza la modalità si applica anche alle produzioni già concluse. Turni dal calendario aziendale HR, secondo le decorrenze, le eccezioni e le chiusure di ciascuna data, anche nel conteggio della media. 8 ore economiche, mezzo turno superiore e minimo 0,5 solo se ci sono ore entro calendario. Straordinario soltanto se registrato esplicitamente nel consuntivo, al costo medio turno / 8 × ore × moltiplicatore. Nessuna modifica al planning MES; FILLING mantiene i suoi criteri.</p></CostInfo>}</h3><div className="pc-fields">
 ...
 {rules.filling.basis!=="historical_pieces"&&<div className="pc-fields">
