...
export default function MexalAgents() {
  ...
  return <div className="mexal-page">
    ...
    <section className="mexal-table-panel"><div className="mexal-section-heading"><div><h3>Elenco agenti</h3><p>Nome, cognome, codice, email e telefono vengono aggiornati da Mexal. Responsabile e accesso restano sotto controllo Workspace.</p></div></div>
