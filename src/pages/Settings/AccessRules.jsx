...
const EMPTY_ROLE = { nome: "", descrizione: "", amministratore_workspace: false, ambito_dati: "propri", ambito_team: "associazioni", livello_accesso: "lettura", livello_ai: "analisi" };
...
export default function AccessRules() {
  ...
  const loadData = useCallback(async () => {
    ...
    const results = await Promise.all([
      supabase.from("ruoli").select("id,nome,descrizione,amministratore_workspace,ambito_dati,ambito_team,livello_accesso,livello_ai,accesso_come_beauty").order("nome"),
      ...
      supabase.from("workspace_moduli").select("codice,nome,area,aree,attivo,assegnabile_reparto,configurabile_ruolo,ordine").eq("attivo", true).order("ordine"),
  ...
  async function save() {
    ...
    const payload = mode === "profili" ? {
      ...
      ambito_dati: form.ambito_dati || "propri", ambito_team: form.ambito_team || "associazioni", livello_accesso: form.livello_accesso || "lettura", livello_ai: form.livello_ai || "analisi", accesso_come_beauty: form.accesso_come_beauty === true,
