...
export function costRows(record) {
 ...
 return [
  ...
  {name:"Margine obiettivo STATION previsto",p:r.plannedObjective,a:r.invoicedObjective,separate:true,info:"Obiettivo fisso configurato per ogni lavorazione STATION, conteggiato una sola volta indipendentemente dal numero di turni."},
