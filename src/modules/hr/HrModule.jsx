...
export default function HrModule({ configuration = false }) {
  ...
  const calendarActive = page === 'calendar';
  ...
  const tabs = configuration ? [['employees', UsersRound, 'Schede dipendente'], ['company-calendar', CalendarDays, 'Calendario aziendale'], ['sites', MapPin, 'Sedi e timbrature'], ['export', CalendarDays, 'Esporta presenze'], ['economics', Timer, 'Riepilogo economico'], ['audit', Clock3, 'Storico modifiche']]
