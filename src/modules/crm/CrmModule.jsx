...
const CRM_KPI_INFO = {
  ...
  "Progetti aperti": "Numero di progetti CRM non chiusi nel perimetro corrente.",
...
function CrmDashboard({ type }) {
  ...
  return <div className="crm-page">
    ...
    {loading ? <div className="crm-loading">Caricamento KPI...</div> : <div className="crm-kpi-grid">
      ...
      <Kpi label="Progetti aperti" value={Number(data.open_opportunities || 0).toLocaleString("it-IT")} to={period.withPeriod(`${config.basePath}/pipeline`, { status: "open" })} />
...
function AccountDetail({ type }) {
  ...
  return <div className="crm-page">
    ...
    {(account.crm_account_id || account.codice_cliente_mexal) ? <div className="crm-kpi-grid crm-account-operational-kpis">
      <Kpi label="Progetti aperti" value={Number(commercialSnapshot.opportunities?.open_count || 0).toLocaleString("it-IT")} note={formatMoney(commercialSnapshot.opportunities?.pipeline_value)} to={period.withPeriod(`${config.basePath}/pipeline`, { status: "open" })} />
...
function Pipeline({ type, forceList = false }) {
  ...
  return <div className="crm-page">
    ...
    <div className="crm-kpi-grid">
      <Kpi label="Progetti aperti" value={Number(pipelineMetrics.open_opportunities || 0).toLocaleString("it-IT")} to={period.withPeriod(`${config.basePath}/pipeline`, { status: "open" })} />
    ...
    {canWrite ? <form className="crm-card-form crm-project-create-form" onSubmit={create}>
      ...
      <button className="primary-action crm-primary"><Plus size={16} />Crea progetto</button>
    </form> : null}
