...
export default function NewOrder() {
  ...
  function withEconomics(line) {
    ...
    const rawVat = product.aliquota_iva ?? product.dati_mexal?.aliquota_iva ?? product.dati_mexal?.perc_iva ?? 0;
    return calculateOrderEconomics([{
      ...
      codice_iva_mexal: product.codice_iva_mexal ?? product.cod_iva ?? product.dati_mexal?.cod_iva ?? product.dati_mexal?.codice_iva ?? null,
      aliquota_iva: rawVat,
                ...
                return (
                  <Fragment key={line.codice_articolo}>
                    <tr>
                      ...
                      <td>{money(line.iva_riga)} <small>({line.aliquota_iva || 0}%)</small></td>
