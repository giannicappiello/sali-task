...
const ACCOUNT_COLUMNS = [
  ...
  { value: (row) => row.average_gap_days == null ? "—" : `${Number(row.average_gap_days).toLocaleString("it-IT", { maximumFractionDigits: 1 })} gg` },
