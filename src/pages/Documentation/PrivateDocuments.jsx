...
export default function PrivateDocuments() {
  ...
  return <div className="private-documents-page">
    ...
    <div className="private-documents-master-detail">
      ...
      {["finished", "bulk"].includes(articleSection(selected.article)) && <ProductSpecification key={`${authSession?.user?.id}-${customerScoped}-${selected.article.articleCode}`} article={selected.article} canEdit={canUpload && !customerScoped} request={requestNas} drafts={specificationDrafts}/>}
