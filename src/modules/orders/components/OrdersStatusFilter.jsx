...
const ORDER_STATUS_OPTIONS = Object.freeze([
  ...
  Object.freeze({ value: "inviato-mexal", label: "Inviato" }),
  Object.freeze({ value: "annullato", label: "Non presente" }),
  Object.freeze({ value: "fatturato", label: "Fatturato" }),
  Object.freeze({ value: "parzialmente-fatturato", label: "Parzialmente fatturato" }),
  Object.freeze({ value: "fattura-collegata", label: "Fattura collegata" }),
