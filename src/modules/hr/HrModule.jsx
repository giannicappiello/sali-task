...
const KIND = { leave: 'Ferie', permission: 'Permesso', illness: 'Malattia', pregnancy: 'Gravidanza', unjustified: 'Assente ingiustificato', overtime: 'Straordinario', correction: 'Correzione uscita' };
