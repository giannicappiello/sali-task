...
begin
  ...
  with consumed as (
    ...
    select u.*,coalesce(r.amministratore_workspace,false) is_admin,coalesce(r.livello_ai,'nessuno') role_ai_level,c.schermata_codice requested_screen,c.percorso_destinazione requested_path
