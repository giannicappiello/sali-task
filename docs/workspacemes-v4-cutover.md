...
4. L’operatore decide soltanto se creare gli OdP. Il server seleziona automaticamente `COMPLETE` quando non ci sono carenze oppure `WITH_SHORTAGES` quando la preview certifica carenze; in questo secondo caso Workspace crea automaticamente i fabbisogni acquisto.
