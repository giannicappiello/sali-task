  ...
  return <section className="commercial-screen">
    ...
    <section className="commercial-panel">
      ...
      {loading ? <div className="commercial-empty" role="status">Caricamento ordini e avanzamento…</div> : <>
        ...
        <div className="commercial-scroll"><table className="commercial-orders-table"><thead><tr><th>OCT / RdP</th><th>Cliente / articoli</th><th>Consegna richiesta</th><th>Ultimazione prevista</th><th>Stato ordine</th>{!customerScoped && <th>Azioni</th>}</tr></thead><tbody>
