...
export default function HrModule({ configuration = false }) {
  ...
  const tabs = configuration ? [['employees', UsersRound, 'Schede dipendente'], ['calendar', CalendarDays, 'Calendario presenze'], ['company-calendar', CalendarDays, 'Calendario aziendale'], ['sites', MapPin, 'Sedi e timbrature'], ['export', CalendarDays, 'Esporta presenze'], ['economics', Timer, 'Riepilogo economico'], ['audit', Clock3, 'Storico modifiche']]
    : [['personal', Clock3, 'Le mie presenze'], ['calendar', CalendarDays, 'Calendario presenze'], ['leave', CalendarCheck, 'Ferie e permessi'], ['overtime', Timer, 'Straordinari']];
