...
export default function DigitalIntegrationStatus() {
  ...
  return <div className="crm-page">
    ...
    <div className="crm-kpi-grid"><article className="crm-kpi"><span>Connessioni</span><strong>{diagnostics.connectionCount || 0}</strong><small>Account configurati</small></article><article className="crm-kpi"><span>Attive</span><strong>{diagnostics.activeCount || 0}</strong><small>Test superato e attivate</small></article><article className="crm-kpi"><span>Errori</span><strong>{diagnostics.failedCount || 0}</strong><small>Richiedono intervento Admin</small></article><article className="crm-kpi"><span>Scheduler</span><strong>{diagnostics.scheduler || "daily"}</strong><small>Dispatcher server-side reale</small></article></div>
