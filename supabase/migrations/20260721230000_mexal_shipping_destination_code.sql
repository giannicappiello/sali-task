-- Usa il codice anagrafico interno Mexal del destinatario.
-- Il GET di un OCM manuale conferma che cod_anag_sped e' una matrice contenente
-- il codice interno (es. 754), non il conto cliente 501.xxxxx.
