...
export default function PrivateDocuments() {
  ...
  async function upload(event) {
    ...
    setUploading(true);
    try {
      const uploadSession = await workspaceAction(accessToken, "private_documents_session", { upload: true });
      await mesRequest(uploadSession, "documents/reference", { method: "POST", body: formData });
      setUploadOpen(false);
