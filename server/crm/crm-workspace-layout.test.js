...
test("tutte le 24 destinazioni CRM passano dal layout e dalla guardia Workspace", () => {
  assert.equal(CRM_ROUTE_CATALOG.length, 24);
...
test("la classificazione è integrata nella Panoramica senza introdurre una nuova route", () => {
