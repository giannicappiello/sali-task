...
assert.match(automationSource, /runScheduledStep[\s\S]*if \(syncType === "stocks"\) \{[\s\S]*?body\.resume = true/, "ogni job pianificato riprende automaticamente una run stocks orfana");
