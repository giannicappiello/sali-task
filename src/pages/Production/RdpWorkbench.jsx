  ...
  return <section className="rdp-decisions rdp-v3-panel">
    ...
    {preview && <>
      ...
      {["READY", "BLOCKED"].includes(preview.status) && !v3.saga && canDecide && <>
        <button type="button" className="primary-action rdp-v3-recalculate" onClick={onConfirm} disabled={busy || !confirmEnabled}><Factory size={16}/>Conferma e genera OP</button>
