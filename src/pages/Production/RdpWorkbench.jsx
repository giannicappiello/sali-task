...
function DetailPanel({ detail, onClose, onDiagnostics, canDecide, canCancel, onDecision, onRetry, onCancel, onV3Preview, onV3Confirm, busy }) {
  const outcomeLine = detail?.lines?.find((line) => blocking(line.diagnostics) || /BLOCKED|TO_RESOLVE/.test(String(line.mesStatus || line.mappingStatus || "").toUpperCase()));
